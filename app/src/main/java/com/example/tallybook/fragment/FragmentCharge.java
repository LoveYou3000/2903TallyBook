        ...
        bmobQuery.findObjects(new FindListener<Budget>() {
            ...
            public void done(List<Budget> list, BmobException e) {
                if (e == null) {
                    ...
                    showToast(getActivity(), "查询当月预算失败", e);
                }
            }
        });
    ...
    private void showCategory(String[] names) {
        ...
        for (int i = 0; i < names.length; i++) {
            ...
            try {
                ...
                layoutParams.width = (Objects.requireNonNull(getActivity())
                        .getResources().getDisplayMetrics().widthPixels - 160) / 4;
                layoutParams.height = (Objects.requireNonNull(getActivity())
                        .getResources().getDisplayMetrics().widthPixels - 160) / 4;
                ...
                textView.setText(getActivity().getResources()
                        .getString(Integer.parseInt(Objects.requireNonNull(fieldCn.get(null)).toString())));
                ...
                block.setOnClickListener(v -> {
                    ...
                    TextView detailCategory = inputView.findViewById(R.id.detail_category);
                    ...
                    detailCategory.setText(textView.getText().toString());
                                ...
                                if (e == null) {
                                    ...
                                    budget.update(new UpdateListener() {
                                        ...
                                        public void done(BmobException e) {
                                            if (e == null) {
                                                showToast(getActivity(), "更新预算成功");
                                            } else {
                                                showToast(getActivity(), "更新预算失败", e);
                                            }
                                        }
                                    });
                                } else {
                                    showToast(getActivity(), "记录失败", e);
                                }
                            }
                        });
